...
return new class extends Migration
{
    ...
    {
        Schema::create('multiplataforma_productos', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('empresa_id')->constrained('empresas');
            $table->foreignId('tipo_producto_id')->constrained('tipo_productos')->cascadeOnDelete();
            $table->foreignId('multiplataforma_prioridad_id')->nullable()->constrained('multiplataforma_prioridades')->nullOnDelete();
            $table->foreignId('multiplataforma_plataforma_id')->nullable()->constrained('multiplataforma_plataformas')->nullOnDelete();
            $table->json('multiplataforma_plataformas_ids')->nullable();
            $table->foreignId('multiplataforma_equipo_id')->nullable()->constrained('multiplataforma_equipos')->nullOnDelete();
            $table->foreignId('multiplataforma_tipo_id')->nullable()->constrained('multiplataforma_tipos')->nullOnDelete();
    ...
    {
        Schema::dropIfExists('multiplataforma_productos');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::create('multiplataforma_horarios_slots', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unique(['empresa_id', 'dia_semana', 'hora'], 'multiplataforma_horarios_empresa_dia_hora_unique');
        });
    ...
    {
        Schema::dropIfExists('multiplataforma_horarios_slots');
    }
};

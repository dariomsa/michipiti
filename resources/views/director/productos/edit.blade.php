...
@php
  ...
  $directorRevisionLabel = $producto->estado === 'EN_REVISION' ? 'Enviar a diseño' : 'Enviar a revisión';
@endphp
          ...
          <form method="POST"
            ...
            <div class="editor-actions">
              ...
              @unless($readOnly)
                ...
                <button type="button" class="btn btn-action-return rounded-0" id="btnDevolverPeriodista">
...
<div class="modal fade" id="modalDevolverPeriodista" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content rounded-0">
      <div class="modal-header">
        <h5 class="modal-title">Devolver al periodista</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
      </div>
      ...
      <div class="modal-body">
        ...
        <textarea class="form-control rounded-0"
                  id="motivoDevolucion"
                  rows="3"
                  placeholder="Explica por qué se devuelve al periodista..."></textarea>
        <div class="invalid-feedback" id="motivoDevolucionError">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-action-return rounded-0" id="btnConfirmarDevolverPeriodista">
          Enviar
        </button>
      </div>
    </div>
...
(() => {
  ...
  const btnDevolverPeriodista = document.getElementById('btnDevolverPeriodista');
  ...
  const btnConfirmarDevolverPeriodista = document.getElementById('btnConfirmarDevolverPeriodista');
  ...
  function openDevolverPeriodistaModal() {
    if (window.bootstrap && modalDevolverPeriodistaEl) {
      bootstrap.Modal.getOrCreateInstance(modalDevolverPeriodistaEl).show();
    }
  }
  ...
  if (btnDevolverPeriodista) {
    btnDevolverPeriodista.addEventListener('click', () => {
      openDevolverPeriodistaModal();
    });
  }

  if (motivoDevolucion) {
    motivoDevolucion.addEventListener('input', () => {
  ...
  if (btnConfirmarDevolverPeriodista) {
    btnConfirmarDevolverPeriodista.addEventListener('click', () => {
      ...
      accionHidden.value = 'devolver_periodista';
      submitMainForm();
    });
  }
